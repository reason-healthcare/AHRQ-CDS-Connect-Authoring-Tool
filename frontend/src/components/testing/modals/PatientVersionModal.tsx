...
interface PatientVersionModalProps {
  handleCloseModal: () => void;
  handleSelectVersion: (version: string) => void | Promise<void>;
  versionOptions?: string[];
}

const PatientVersionModal: React.FC<PatientVersionModalProps> = ({
  handleCloseModal,
  handleSelectVersion,
  versionOptions = ['R4', 'STU3', 'DSTU2']
}) => {
