...
interface LookBackModifierProps {
  handleUpdateModifier: (updates: { unit?: string | null; value?: number | null }) => void;
  unit?: string;
  value?: number | null;
}

const LookBackModifier: React.FC<LookBackModifierProps> = ({ handleUpdateModifier, unit, value }) => {
    ...
    <div className={styles.modifier}>
      ...
      <TextField
        ...
        onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
          ...
          handleUpdateModifier({ value: Number.isNaN(newValue) ? null : newValue });
        }}
        type="number"
