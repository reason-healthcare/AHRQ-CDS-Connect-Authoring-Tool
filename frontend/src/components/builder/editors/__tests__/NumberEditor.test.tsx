...
interface NumberValue {
  decimal?: string;
  str?: string;
  firstInteger?: string | null;
  secondInteger?: string | null;
  firstDecimal?: string | null;
  secondDecimal?: string | null;
}

interface RenderComponentProps {
  errors?: { invalidInput?: boolean; [key: string]: unknown };
  handleUpdateEditor?: jest.Mock;
  isDecimal?: boolean;
  isInterval?: boolean;
  value?: string | NumberValue | null;
  [key: string]: unknown;
}
...
describe('<NumberEditor />', () => {
  ...
  describe('Integer Editor', () => {
    it('calls handleUpdateEditor with valid integer', () => {
      ...
      expect(handleUpdateEditor).toHaveBeenCalledWith('0');
    });
  ...
  describe('Decimal Editor', () => {
    it('calls handleUpdateEditor with valid decimal', () => {
      ...
      expect(handleUpdateEditor).toHaveBeenCalledWith({ decimal: '0.1', str: '0.1' });
    });
    ...
    it('calls handleUpdateEditor with valid decimal having trailing zero', () => {
      ...
      expect(handleUpdateEditor).toHaveBeenCalledWith({ decimal: '0.0', str: '0.0' });
    });
    ...
    it('calls handleUpdateEditor with valid decimal having multiple trailing zeros', () => {
      ...
      expect(handleUpdateEditor).toHaveBeenCalledWith({ decimal: '0.000', str: '0.000' });
    });
    ...
    it('calls handleUpdateEditor with valid integer', () => {
      ...
      expect(handleUpdateEditor).toHaveBeenCalledWith({ decimal: '0', str: '0.0' });
    });
