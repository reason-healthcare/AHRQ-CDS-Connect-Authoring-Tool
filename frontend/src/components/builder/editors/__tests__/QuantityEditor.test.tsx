...
interface QuantityValue {
  ...
  secondQuantity?: string | null;
}

interface RenderComponentProps {
  errors?: { invalidInput?: boolean; incompleteInput?: boolean; [key: string]: unknown };
...
describe('<QuantityEditor />', () => {
  ...
  describe('Quantity Editor', () => {
    it('calls handleUpdateEditor with valid decimal and no unit', () => {
      ...
      expect(handleUpdateEditor).toHaveBeenCalledWith({ quantity: '0.1', unit: '', str: `0.1 '1'` });
    });
    ...
    it('calls handleUpdateEditor with valid decimal having trailing zero and no unit', () => {
      ...
      expect(handleUpdateEditor).toHaveBeenCalledWith({ quantity: '0.0', unit: '', str: `0.0 '1'` });
    });
    ...
    it('calls handleUpdateEditor with valid decimal having multiple trailing zeros and no unit', () => {
      ...
      expect(handleUpdateEditor).toHaveBeenCalledWith({ quantity: '0.000', unit: '', str: `0.000 '1'` });
    });
    ...
    it('calls handleUpdateEditor with valid integer and no unit', () => {
      ...
      expect(handleUpdateEditor).toHaveBeenCalledWith({ quantity: '0', unit: '', str: `0.0 '1'` });
    });
    ...
    it('calls handleUpdateEditor with valid value and unit', async () => {
      ...
      expect(handleUpdateEditor).toHaveBeenCalledWith({ quantity: '1.0', unit: 'mg/dL', str: `1.0 'mg/dL'` });
