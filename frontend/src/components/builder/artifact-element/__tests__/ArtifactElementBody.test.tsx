...
describe('<ArtifactElementBody />', () => {
  ...
  it('should render validation errors', () => {
    const elementInstanceWithValidationError: Instance = {
      fields: [
  ...
  it('should render return type errors', () => {
    const elementInstanceWithReturnTypeError: Instance = {
      fields: [
        {
          id: 'element_name',
          type: 'string',
  ...
  it('should render an expression phrase', () => {
    const elementInstance: Instance = {
      name: 'Age Range',
      returnType: 'boolean',
      modifiers: [],
      fields: [
  ...
  it('should render External CQL field arguments', () => {
    ...
    const externalCQLElementInstance: Instance = {
  ...
  it('should render references to other elements from External CQL arguments', () => {
    ...
    const baseElementReference = container.childNodes[3] as HTMLElement;
  ...
  it('should render references to base elements with a link', () => {
    const baseElementUseElementInstance: Instance = {
      tab: 'expTreeInclude',
      uniqueId: '345',
      name: 'Procedure',
    ...
    const procedureBaseElement: Instance = {
      tab: 'baseElements',
      name: 'Procedure',
    ...
    const baseElementReference = container.childNodes[1] as HTMLElement;
  ...
  it('should render references to external CQL element without a link', () => {
    ...
    const externalCQLReference = container.childNodes[2] as HTMLElement;
  ...
  it("should render a reference to a BaseElement's uses", () => {
    ...
    const elementUseReference = container.childNodes[4] as HTMLElement;
  ...
  it('should render modifiers when present', () => {
    ...
    const modifiers = container.childNodes[2] as HTMLElement;
    ...
    const returnType = container.childNodes[2] as HTMLElement;
  ...
  it('renders the return type', () => {
    ...
    const { container } = renderComponentWithState({ elementInstance: elementInstance });
    const modifiers = container.childNodes[2] as HTMLElement;
