...
const waitForCheckboxToCheck = async (input: HTMLInputElement, expectedValue: boolean): Promise<void> => {
...
describe('<TermsAndConditions />', () => {
  it('allows accepting terms and closes', async () => {
    ...
    const acceptCheckbox = dialog.getByRole('checkbox') as HTMLInputElement;
