...
describe('<ValueSetSelectModal />', () => {
  ...
  const testVsacSearchResults: ValueSet[] = [
  ...
  const renderComponent = (props: RenderComponentProps = {}) =>
    render(
      <Provider store={createStore((x: RootState) => x, { vsac: { apiKey } } as RootState)}>
        <ValueSetSelectModal
          handleCloseModal={jest.fn()}
          handleSelectValueSet={jest.fn()}
          savedValueSet={(props.savedValueSet as any) || null}
          readOnly={false}
          {...props}
        />
      </Provider>
