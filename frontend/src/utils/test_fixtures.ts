...
interface ElementGroup {
  ...
  icon: string;
  name: string;
  entries: TemplateInstance[];
}

interface GenericElementType {
  value: string;
  label: string;
 ...
 */
const instanceTree: TemplateInstance = {
  id: 'And',
  name: 'And',
  conjunction: true,
  returnType: 'boolean',
...
const emptyInstanceTree: TemplateInstance = {
  id: 'And',
  name: 'And',
  conjunction: true,
  returnType: 'boolean',
...
const simpleObservationInstanceTree: TemplateInstance = {
  id: 'And',
  name: 'And',
  conjunction: true,
  returnType: 'boolean',
...
const simpleConditionInstanceTree: TemplateInstance = {
  id: 'And',
  name: 'And',
  conjunction: true,
  returnType: 'boolean',
...
const simpleProcedureInstanceTree: TemplateInstance = {
  id: 'And',
  name: 'And',
  conjunction: true,
  returnType: 'boolean',
...
const simpleImmunizationInstanceTree: TemplateInstance = {
  id: 'And',
  name: 'And',
  conjunction: true,
  returnType: 'boolean',
...
const genericElementTypes: GenericElementType[] = [
  {
...
const genericElementGroups: ElementGroup[] = [
  {
    id: 1,
    icon: 'user',
    name: 'Demographics',
...
const genericInstance: TemplateInstance = {
  id: 'GenericObservation_vsac',
  name: 'Observation',
  returnType: 'list_of_observations',
  suppress: true,
...
const genericBaseElementInstance: TemplateInstance & { usedBy: string[] } = {
  ...genericInstance,
  usedBy: ['testId1'],
...
const genericBaseElementListInstance: TemplateInstance & { usedBy: string[]; childInstances: TemplateInstance[] } = {
  id: 'Union',
  name: 'Union',
  conjunction: true,
  returnType: 'list_of_observations',
...
const genericBaseElementListAndInstance: TemplateInstance & { usedBy: string[] } = {
  id: 'And',
  name: 'And',
  conjunction: true,
  returnType: 'boolean',
...
const genericBaseElementUseInstance: TemplateInstance = {
  id: 'GenericObservation_vsac',
  name: 'BaseElement',
  returnType: 'boolean',
  type: 'baseElement',
...
interface ReduxState {
  ...
  externalCQL: {
    ...
    externalCQLLibraryParents: Record<string, unknown>;
    externalCqlList: unknown[];
  };
  navigation: {
    activeTab: number;
