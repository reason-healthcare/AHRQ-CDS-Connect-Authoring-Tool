...
describe('list utils', () => {
  ...
  describe('#checkReturnTypeCompatibilityBooleanList', () => {
    it('should calculate return types of And and Or lists', () => {
      const boolAndBool = checkReturnTypeCompatibilityBooleanList('boolean', 'boolean', false);
      expect(boolAndBool).toEqual('boolean');

      const observations = checkReturnTypeCompatibilityBooleanList('list_of_observations', 'observation', false);
      expect(observations).toEqual('invalid');

      const conditions = checkReturnTypeCompatibilityBooleanList('list_of_conditions', 'list_of_conditions', false);
      expect(conditions).toEqual('invalid');

      const conditionsAndBool = checkReturnTypeCompatibilityBooleanList('list_of_conditions', 'boolean', false);
      expect(conditionsAndBool).toEqual('invalid');

      const boolAndNone = checkReturnTypeCompatibilityBooleanList('boolean', 'none', false);
      expect(boolAndNone).toEqual('boolean');

      const noneAndBool = checkReturnTypeCompatibilityBooleanList('none', 'boolean', false);
      expect(noneAndBool).toEqual('boolean');

      const boolAndInvalid = checkReturnTypeCompatibilityBooleanList('boolean', 'invalid', false);
