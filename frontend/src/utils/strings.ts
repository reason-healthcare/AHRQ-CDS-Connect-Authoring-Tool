...
export type CaseType = 'camelCase' | 'capitalCase' | 'constantCase' | 'noCase' | 'noCaseWithParens' | 'snakeCase';

export const changeToCase = (string: string, desiredCase: CaseType): string | null => {
...
export const startsWithVowel = (toCheck: string): RegExpMatchArray | null => {
